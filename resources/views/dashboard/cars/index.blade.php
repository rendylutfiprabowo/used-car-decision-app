 ...
 @section('content')
             ...
             <div class="card">
                 ...
                 <div class="card-body">
                     <button type="button" class="btn btn-primary mb-3" data-bs-toggle="modal"
                         data-bs-target="#create-car-modal">Tambah Mobil</button>
     ...
     <div class="modal fade" id="create-car-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true">
                 ...
                 <div class="modal-body p-3">
                     <form method="POST" id="create-car-form">
                         ...
                         <div class="mb-3">
                             ...
                             <div class="input-group">
                                 ...
                                 <input type="text" class="form-control" id="price" name="price"
                                     data-toggle="input-mask" data-mask-format="999.999.999.999" placeholder="-"
                                     data-reverse="true" required>
                             </div>
                         </div>

                         <div class="mb-3">
                             <label for="release_date" class="form-label">Tanggal Rilis</label>
                             <input type="date" class="form-control datepicker" id="release_date" name="release_date"
                         ...
                         <div class="mb-3">
                             ...
                             <input type="date" class="form-control datepicker" id="first_registration_date"
                                 name="first_registration_date" data-provide="datepicker" data-date-format="yyyy-mm-dd"
                                 required>
                         </div>
                         ...
                         <div class="mb-3">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="kilometer_used" name="kilometer_used"
                                     data-toggle="input-mask" data-mask-format="999.999.999.999" placeholder="-"
                                     data-reverse="true" required>
                         ...
                         <div class="mb-3">
                             ...
                             <div class="input-group">
                                 <input type="text" class="form-control" id="fuel_efficiency" name="fuel_efficiency"
                                     data-toggle="input-mask" data-mask-format="999.999.999.999" placeholder="-"
                                     data-reverse="true" required>
                         ...
                         <div class="mb-3">
                             ...
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="fuel_type" id="fuel_bensin"
                                     value="bensin" checked>
                                 <label class="form-check-label" for="fuel_bensin">Bensin</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="fuel_type" id="fuel_diesel"
                                     value="diesel">
                                 <label class="form-check-label" for="fuel_diesel">Diesel</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="fuel_type" id="fuel_elektrik"
                                     value="elektrik">
                         ...
                         <div class="mb-3">
                             ...
                             <input type="text" class="form-control datepicker" id="warranty_showroom"
                                 name="warranty_showroom" data-provide="datepicker" data-date-format="yyyy-mm-dd"
                                 required>
                         </div>
                         ...
                         <div class="mb-3">
                             ...
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="type" id="type_auto"
                                     value="auto">
                                 <label class="form-check-label" for="type_auto">Auto</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="type" id="type_semi_auto"
                                     value="semiauto">
                         ...
                         <div class="mb-3">
                             ...
                             <input type="file" name="image" class="form-control dropify" data-max-file-size="3M"
                                 accept="image/*">
                         </div>
                     </form>
                 </div>
     ...
     <!--  Modal content for the Large example -->
     <div class="modal fade" id="edit-car-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true">
         <div class="modal-dialog">
             <div class="modal-content">
                 <div class="modal-header">
                 ...
                 <div class="modal-body p-3">
                     <form method="POST" id="edit-car-form" data-car-uuid="">
                         ...
                         <div class="mb-3">
                             <label for="release_date" class="form-label">Tanggal Rilis</label>
                             <input type="date" class="form-control datepicker" id="edit-release_date"
                                 name="release_date" data-provide="datepicker" data-date-format="yyyy-mm-dd" required>
                         </div>

                         <div class="mb-3">
                             <label for="first_registration_date" class="form-label">Tanggal Mulai Pemakaian</label>
                             <input type="date" class="form-control datepicker" id="edit-first_registration_date"
                                 name="first_registration_date" data-provide="datepicker" data-date-format="yyyy-mm-dd"
                                 required>
                         </div>
                         ...
                         <div class="mb-3">
                             ...
                             <div class="input-group">
                                 <span class="input-group-text">Km </span>
                                 <input type="text" class="form-control" id="edit-kilometer_used"
                                     name="kilometer_used" data-toggle="input-mask" data-mask-format="999.999.999.999"
                                     placeholder="-" data-reverse="true" required>
                             </div>
                         </div>
                         ...
                         <div class="mb-3">
                             ...
                             <div class="input-group">
                                 <span class="input-group-text">Km/Liter </span>
                                 <input type="text" class="form-control" id="edit-fuel_efficiency"
                                     name="fuel_efficiency" data-toggle="input-mask" data-mask-format="999.999.999.999"
                                     placeholder="-" data-reverse="true" required>
                             </div>
                         </div>
                         ...
                         <div class="mb-3">
                             <label for="fuel_type" class="form-label">Jenis Bahan Bakar</label><br>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="fuel_type" id="edit-fuel_bensin"
                                     value="bensin" checked>
                                 <label class="form-check-label" for="fuel_bensin">Bensin</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="fuel_type" id="edit-fuel_diesel"
                                     value="diesel">
                                 <label class="form-check-label" for="fuel_diesel">Diesel</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="fuel_type" id="edit-fuel_elektrik"
                                     value="elektrik">
                                 <label class="form-check-label" for="fuel_elektrik">Elektrik</label>
                             </div>
                         </div>
                         ...
                         <div class="mb-3">
                             <label for="warranty_showroom" class="form-label">Garansi (Showroom)</label>
                             <input type="date" class="form-control datepicker" id="edit-warranty_showroom"
                                 name="warranty_showroom" data-provide="datepicker" data-date-format="yyyy-mm-dd"
                                 required>
                         </div>
                         ...
                         <div class="mb-3">
                             <label for="type" class="form-label">Tipe transimis</label><br>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="type" id="edit-type_manual"
                                     value="manual" checked>
                                 <label class="form-check-label" for="type_manual">Manual</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="type" id="edit-type_auto"
                                     value="auto">
                                 <label class="form-check-label" for="type_auto">Auto</label>
                             </div>
                             <div class="form-check form-check-inline">
                                 <input class="form-check-input" type="radio" name="type" id="edit-type_semi_auto"
                                     value="semiauto">
                                 <label class="form-check-label" for="type_semi_auto">Semi-Auto</label>
                             </div>
                         </div>
                         <div class="mb-3" id="image-upload-container">
                             <label for="image" class="form-label">Gambar</label>
                             <input type="file" name="image" id="edit-image" class="form-control dropify"
                                 data-default-file="" data-max-file-size="3M" accept="image/*">
                         </div>
     ...
     <!--  Modal content for the Large example -->
     <div class="modal fade" id="detail-car-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
         aria-hidden="true">
                                             ...
                                             <div class="row align-items-center">
                                                 <div class="col">
                                                     ...
                                                     <p class="mb-2 text-muted"
                                                         id="detail-car-modal-first_registration_date"></p>
                                                 </div>
                                             </div> <!-- end row-->
                                         </div>
                                     </div>
                                         ...
                                         <div class="card-body">
                                             <div class="row align-items-center">
                                                 <div class="col">
                                                     ...
                                                     <p class="mb-2 text-muted" id="detail-car-modal-warranty_showroom">
                                                     </p>
                                                 </div>
                                             </div> <!-- end row-->
                                         </div>
 ...
 @section('scripts')
    ...
    <script src="https://coderthemes.com/ubold/layouts/assets/libs/bootstrap-datepicker/js/bootstrap-datepicker.min.js">
    </script>
                 ...
                 $('.btn-detail').off('click').on('click', function() {
                     ...
                     $.ajax({
                         ...
                         success: (response) => {
                             ...
                             $('#detail-car-modal-price').text(
                                 `Rp. ${car.price.toString().replace(/\B(?=(\d{3})+(?!\d))/g, ".")}`
                             );
                             $('#detail-car-modal-release_date').text(car.release_date);
                             $('#detail-car-modal-first_registration_date').text(car
                                 .first_registration_date);
                             $('#detail-car-modal-kilometer_used').text(
                                 `${car.kilometer_used.toLocaleString()} Kilometer`);
                             $('#detail-car-modal-fuel_efficiency').text(
                                 `${car.fuel_efficiency.toLocaleString()} Km/Liter`);
                             $('#detail-car-modal-fuel_type').text(car.fuel_type.charAt(0)
                                 .toUpperCase() + car.fuel_type.slice(1));
                             $('#detail-car-modal-warranty_showroom').text(car
                                 .warranty_showroom);
                             $('#detail-car-modal-type').text(car.type.charAt(0).toUpperCase() +
                                 car.type.slice(1));
                 ...
                 $('.btn-edit').off('click').on('click', function() {
                     ...
                     $.ajax({
                         ...
                         success: (response) => {
                             ...
                             $('#edit-price').val(car.price.toString().replace(
                                 /\B(?=(\d{3})+(?!\d))/g, "."));
                             $('#edit-release_date').val(car.release_date);
                             $('#edit-first_registration_date').val(car.first_registration_date);
                             $('#edit-kilometer_used').val(car.kilometer_used.toString().replace(
                                 /\B(?=(\d{3})+(?!\d))/g, "."));
                             $('#edit-fuel_efficiency').val(car.fuel_efficiency.toString()
                                 .replace(/\B(?=(\d{3})+(?!\d))/g, "."));
                             $(`input[name="fuel_type"][value="${car.fuel_type}"]`).prop(
                                 'checked', true);
